...
import slider_image3_mobile from "../../../assets/images/mobile_hero3.svg";
...
const slider_images_mobile: any[] = [
  slider_image1_mobile,
  slider_image2_mobile,
  slider_image3_mobile,
];
...
const Index = () => {
  ...
  return (
    ...
    >
      ...
      {slider_images.map((image, index: number) => (
        <Image
          key={index}
          src={image}
          alt=""
      ...
      {/* {slider_images_mobile.map((image, index) => (
        <Image
          key={index}
          src={image}
          alt=""
          className="carousel-images w-screen h-[calc(100vh-120px)] object-cover car-item absolute top-0 left-0 md:hidden block"
        />
      ))} */}

      <div className="absolute w-full mx-auto sm:-translate-y-[20px] -translate-y-[90px] left-1/2 -translate-x-1/2 ">
        <MoreInfo
          buttonId={1}
