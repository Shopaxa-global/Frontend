...
const Index = () => {
  ...
  return (
    <footer className="bg-[#00000066] h-full font-HM-Sans overflow-y-hidden z-10">
      <div className="grid lg:grid-cols-6 grid-cols-1  border-b-[2px] border-b-[#000] ">
        <div className="py-5 px-3 lg:h-[270px] lg:border-r-[2px] lg:border-r-[#000] lg:border-b-0 border-b-[2px] border-b-[#000]">
          <p
            className="uppercase text-[#0E0C22] text-[12px] lg:mb-5 flex flex-row justify-between items-center"
            onClick={
              isMobile
                ? () => {
          ...
          <div className="h-0 lg:opacity-100 opacity-0 dropdown-newsletter relative lg:top-0 top-3 lg:flex hidden">
        ...
        <div className="py-5 px-3 lg:h-[270px] lg:border-r-[2px] lg:border-r-[#000]  flex flex-col">
          <p
      ...
      <p className="text-center py-6 text-base">
        © {new Date().getFullYear()} Shopaxa{" "}
      </p>
    </footer>
  );
};
